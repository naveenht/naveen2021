...
public class SR_BUD_08 extends ApplicationKeywords {

	BaseClass obj;
	private Boolean status = false;
	ReportPage reportPage;

	public SR_BUD_08(BaseClass obj) {
		super(obj);
		this.obj = obj;
	}

	public void sR_BUD_08() {
		...
		String typeofcategoryLabel=retrieve("Typeofcategory");
		...
		reportPage.selectDropDownValue(typeofcategoryLabel,systemWideCategorytypeValue);
		reportPage.verifyButton(saveReportButton, true);
		reportPage.verifySaveCustomReportPopupButtons(customReportSaveButton);
		...
		reportPage.getSelectedDropDownValue(typeofcategoryLabel,systemWideCategorytypeValue);
		...
		reportPage.selectDropDownValue(typeofcategoryLabel, myReportsCategorytypeValue);
		reportPage.verifyButton(saveReportButton, true);
		reportPage.verifySaveCustomReportPopupButtons(customReportSaveButton);
		...
		reportPage.getSelectedDropDownValue(typeofcategoryLabel, myReportsCategorytypeValue);
