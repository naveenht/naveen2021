...
public class DDR_SDF_13 extends ApplicationKeywords {

	BaseClass obj;
	private Boolean status = false;
	ReportPage reportPage;

	public DDR_SDF_13(BaseClass obj) {
		super(obj);
		this.obj = obj;
	}

	public void dDR_SDF_13() {
		...
		String fiscalHeaderLabel = retrieve("Fiscal Year Header Label");
		...
		reportPage.validateFiscalyearDropDownPopup(fiscalHeaderLabel);
		reportPage.selectDropDownPopupValue(fiscalHeaderLabel, fiscalYearValue);
		...
		reportPage.clickDropDown(fiscalYearLabel);
		reportPage.validateFiscalyearDropDownPopup(fiscalHeaderLabel);
		reportPage.selectDropDownPopupValue(fiscalHeaderLabel, fiscalYearValue1);
		reportPage.clickDropDownClose();
