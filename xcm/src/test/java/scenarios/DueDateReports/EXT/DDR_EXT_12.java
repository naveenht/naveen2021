...
public class DDR_EXT_12 extends ApplicationKeywords {

	BaseClass obj;
	private Boolean status = false;
	ReportPage reportPage;

	public DDR_EXT_12(BaseClass obj) {
		super(obj);
		this.obj = obj;
	}

	public void dDR_EXT_12() {
		...
		int columnPosition7 = reportPage.getSystemWideCustomReportsHeaderPosition(systemWideTableName,
				tableColumnRunLink);
		...
		obj.transferControlToWindow(2);
		validateReportPageTitle(reportPageTitle);
		obj.transferControlToWindow(1);
