...
public class DDR_EXT_08 extends ApplicationKeywords{

	BaseClass obj;
	private Boolean status = false;
	ReportPage reportPage;

	public DDR_EXT_08(BaseClass obj) {
		super(obj);
		this.obj = obj;
	}

	public void dDR_EXT_08() {
		...
		//reportpage.getSelectedDropDownValue(typeOfTaskLabel,systemwidetypeOfTaskValue);
