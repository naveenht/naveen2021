...
public class UR_CLS_05 extends ApplicationKeywords {
	...
	public UR_CLS_05(BaseClass obj) {
		super(obj);
		this.obj = obj;
	}

	public void uR_CLS_05() {
		...
		int columnPosition = reportPage.getSystemWideCustomReportsHeaderPosition(reporttype, reportTitle);
		reportPage.getRowPositionValue(reporttype, columnPosition, reportTitle1);
