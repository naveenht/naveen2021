...
public class CR_SOD_13 extends ApplicationKeywords{
	...
	public CR_SOD_13(BaseClass obj) {
		super(obj);
		this.obj = obj;
		
	}
	
	public void cR_SOD_13() {
		...
		String HeaderTypeOfTask=retrieve("Type Of Task Header Label");
		...
		reportPage.clickDropDown(typeOfTaskLabel);
		reportPage.selectDropDownPopupValue(HeaderTypeOfTask ,typeOfTaskValue1);
		reportPage.clickDropDownClose();
		reportPage.verifyButton(runReportButton, true);
		obj.transferControlToWindow(2);
		obj.validateReportPageTitle(reportPageTitle);
