...
public class CR_SOD_05 extends ApplicationKeywords {

	BaseClass obj;
	private Boolean status = false;
	ReportPage reportPage;
	
	public CR_SOD_05(BaseClass obj) {
		super(obj);
		this.obj = obj;
	}
	
	
	public void cR_SOD_05() {
		...
		String reporttitle1=reportPage.enterTextInSaveCustomReportPopup(reportTitleLabel, reportTitleValue);
		...
		reportPage.getRowPositionValue(tableName,colposition, reporttitle1);
