...
public class CR_EDTL_12 extends ApplicationKeywords{
	BaseClass obj;
	private Boolean status = false;
	ReportPage reportPage;
	
	public CR_EDTL_12(BaseClass obj) {
		super(obj);
		this.obj = obj;
	}

	public void cR_EDTL_12() {
		...
		String chooseReportSaveNextButton=retrieve("Choose Report Save&NextButton");
