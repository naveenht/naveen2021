...
public class AR_WSM_08 extends ApplicationKeywords {

	BaseClass obj;
	private Boolean status = false;
	ReportPage reportPage;

	public AR_WSM_08(BaseClass obj) {
		super(obj);
		this.obj = obj;
	}

	public void aR_WSM_08() {
		...
		String selectCategoryValue2 = retrieve("Select Category Value2");
		...
		reportPage.getSelectedDropDownValue(selectCategoryLabel, selectCategoryValue1);
		...
		reportPage.selectDropDownValue(selectCategoryLabel, selectCategoryValue2);
		reportPage.verifyButton(saveReportButton, true);
		reportPage.verifySaveCustomReportPopupButtons(customReportSaveButton);
		...
		reportPage.getSelectedDropDownValue(selectCategoryLabel, selectCategoryValue2);
