...
public class AR_GD_07 extends ApplicationKeywords {
	...
	public AR_GD_07(BaseClass obj) {
		super(obj);
		this.obj = obj;
	}
	
	
	public void aR_GD_07() {
		...
		String systemWidegroupValue=reportPage.selectRoleNameDropDownValue(groupLabel);
		reportPage.verifyButton(saveReportButton, true);
		reportPage.verifySaveCustomReportPopupButtons(customReportSaveButton);
		...
		String myReportsgroupValue = reportPage.selectRoleNameDropDownValue(groupLabel);
		reportPage.verifyButton(saveReportButton, true);
		reportPage.verifySaveCustomReportPopupButtons(customReportSaveButton);
