...
public class AR_RT_04 extends ApplicationKeywords {

	BaseClass obj;
	private Boolean status = false;
	ReportPage reportPage;

	public AR_RT_04(BaseClass obj) {
		super(obj);
		this.obj = obj;
	}

	public void aR_RT_04() {
		...
		reportPage.selectRoleNameDropDownValue(typeOfTaskLabel);
