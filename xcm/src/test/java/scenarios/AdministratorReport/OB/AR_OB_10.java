...
public class AR_OB_10 extends ApplicationKeywords {
	
	BaseClass obj;
	private Boolean status = false;
	ReportPage reportPage;
	
	public AR_OB_10(BaseClass obj) {
		super(obj);
		this.obj = obj;
	}
	
	public void aR_OB_10() {
		...
		reportPage.clickDeleteExistingReport(systemWideTableName, columnPosition2,rowposition);
		...
		reportPage.clickDeleteExistingReport(myReportsTableName, columnPosition3,rowposition);
		reportPage.enterTextInSaveCustomReportPopup(descriptionInSavePopupLabel, descriptionInSavePopupValue);
		reportPage.verifySaveCustomReportPopupButtons(customReportSaveButton);
