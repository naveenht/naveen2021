...
public class TDR_EXPAND_06 extends ApplicationKeywords {

	BaseClass obj;
	private Boolean status = false;
	ReportPage reportPage;

	public TDR_EXPAND_06(BaseClass obj) {
		super(obj);
		this.obj = obj;
	}

	public void tDR_EXPAND_06()  {
		...
		String tableColumnLink = retrieve("Table Column Link");  // for Run button-column in saved report 
