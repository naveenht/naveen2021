...
public class TDR_EXPAND_10 extends ApplicationKeywords {

	BaseClass obj;
	private Boolean status = false;
	ReportPage reportPage;

	public TDR_EXPAND_10(BaseClass obj) {
		super(obj);
		this.obj = obj;
	}

	public void tDR_EXPAND_10()  {
		...
		//passing desc column position.
		int colposition = reportPage.getSystemWideCustomReportsHeaderPosition(systemWideTableName,
				tableDescriptionColumnHeader);
		...
		int columnPosition3 = reportPage.getSystemWideCustomReportsHeaderPosition(myReportsTableName,
				tableColumnDescriptionLink);
		reportPage.clickExistingRecordLink(myReportsTableName, columnPosition3);
		reportPage.enterTextInSaveCustomReportPopup(descriptionInSavePopupLabel, descriptionInSavePopupValue);
		reportPage.verifySaveCustomReportPopupButtons(customReportSaveButton);
		int colposition1 = reportPage.getSystemWideCustomReportsHeaderPosition(myReportsTableName,
				tableDescriptionColumnHeader);
