...
public class TDR_SBS_004 extends ApplicationKeywords {
	...
	public TDR_SBS_004(BaseClass obj) {
		super(obj);
		this.obj = obj;
	}
	
	
	public void tDR_SBS_004() {
		...
		int colposition=reportPage.getSystemWideCustomReportsHeaderPosition(reporttype,reportTitlenew1);
