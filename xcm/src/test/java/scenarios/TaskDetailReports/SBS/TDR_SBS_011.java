...
public class TDR_SBS_011 extends ApplicationKeywords {
	...
	public TDR_SBS_011(BaseClass obj) {
		super(obj);
		this.obj = obj;
	}
	
	
	public void tDR_SBS_011() {
		...
		String chooseReportSaveandnextButton=retrieve("Choose Report Save&next Button");
		...
		reportPage.verifyChooseButtons( chooseReportSaveandnextButton, true);
		...
		obj.transferControlToWindow(2);
		reportPage.verifyChooseButtons(resetButton, true);
		List<String> headerLabels2 = reportPage.selectColumnHeaderCheckbox(noOfCheckBoxes);
		reportPage.verifyChooseButtons( chooseReportSaveandnextButton, true);
		reportPage.verifyChooseButtons( chooseReportSaveCloseButton, true);
		obj.transferControlToWindow(1);
		reportPage.verifyButton(runReportButton, true);
		obj.transferControlToWindow(2);
		reportPage.validateColumnHeaders(headerLabels2);
		obj.validateReportPageTitle(reportPageTitle);
		obj.transferControlToWindow(1);
