...
public class TDR_DET_07 extends ApplicationKeywords {
	...
	public TDR_DET_07(BaseClass obj) {
		super(obj);
		this.obj = obj;
	}
	
	
	public void tDR_DET_07() {
		...
		reportPage.verifyButton(saveReportButton, true);
		String myReportTitleValue=reportPage.enterTextInSaveCustomReportPopup(reportTitleLabel, myReportsColumnValue);
		reportPage.enterTextInSaveCustomReportPopup(reportDescriptionLabel, reportDescriptionValue);
		reportPage.verifySaveCustomReportPopupButtons(customReportSaveButton);
		
		int columnPosition6=reportPage.getSystemWideCustomReportsHeaderPosition(myReportsTableName,tableColumnHeader);
		int rowPosition2=reportPage.getRowPositionValue(myReportsTableName,columnPosition6, myReportTitleValue);
		...
		int rowPosition3=reportPage.getRowPositionValue(myReportsTableName,columnPosition5, myReportTitleValue);
